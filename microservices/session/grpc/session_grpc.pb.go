...
type AuthCheckerClient interface {
	Create(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Nothing, error)
...
func (c *authCheckerClient) Create(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
type AuthCheckerServer interface {
	Create(context.Context, *Session) (*Nothing, error)
...
func (UnimplementedAuthCheckerServer) Create(context.Context, *Session) (*Nothing, error) {
...
var AuthChecker_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "microservice_session/session/session.proto",
}
